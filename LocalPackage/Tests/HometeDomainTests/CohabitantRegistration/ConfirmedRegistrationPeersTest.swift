...
struct ConfirmedRegistrationPeersTest {
    ...
    func isLeadPeer_follower_case(myPeerIDString: String) throws {
        ...
        let actual = peers.isLeadPeer(connectedPeers: connectedPeers, myPeerID: .init(displayName: myPeerIDString))
